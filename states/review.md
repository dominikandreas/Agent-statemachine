...
## Allowed actions
- run tests or checks
- inspect diffs or status
- inspect docs consistency
- inspect artifact hygiene
- inspect whether deprecated, duplicate, or wrong-layer boundaries were violated
- produce review notes or follow-up tasks
...
- does code live in the correct layer or package?
- is a refactor warranted before more work piles onto the current shape?
- are docs up to date?
- did we create junk artifacts or dead paths?
- did we accidentally touch deprecated, duplicate, or non-authoritative code paths?
- did the review verdict get applied to the correct work unit and recorded in the correct memory or state files?

## Correction rule
- If you realize the review was attached to the wrong work unit, wrong state, or wrong recorded conclusion, fix the affected memory or state files immediately in the same turn before replying.
